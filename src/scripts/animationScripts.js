...
export async function skipAnimation(page) {
  //similar to the animatePage function. It finds all of the relevant elements and sets the hasBeenAnimated to true. The animatino loop will stop when it sees this attribute.
  for (let child of page.children) {
    if (child.tagName == "H1") {
