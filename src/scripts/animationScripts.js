...
export async function skipAnimation(page) {
    //similar to the animatePage funciton. It finds all of the relevant elements and sets the hasBeenAnimate to true. The animatino loop will stop when it sees this.
    for (let child of page.children) {
        if (child.tagName == 'H1') {
